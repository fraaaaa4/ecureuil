...
### Compatibility
Compatibility for each app must be specified by the uploader; you must specify all versions that are supported (e.g. if an app supports both 8.0 and 8.1, you must specify both of them. A method inside automatically verifies your NT version, and checks if it's compatible.

Since I have planned to make an x86 compilation of Ecureuil also, and should work on 2000 onwards, this OS checker includes checks also for older and newer versions of Windows.
